...
public class PresentationPostsView extends Div {
	public static List<PostDTO> postData = Arrays.asList( //
			new PostDTO("https://randomuser.me/api/portraits/men/42.jpg", "John Smith", LocalDate.of(2020, 5, 10),
					...
					"10K", "22", "11"),
			new PostDTO("https://randomuser.me/api/portraits/women/42.jpg", "Abagail Libbie", LocalDate.of(2020, 10, 14),
					...
					"1K", "500", "20"),
			new PostDTO("https://randomuser.me/api/portraits/men/24.jpg", "Alberto Raya", LocalDate.of(2014, 1, 10),
					...
					"1K", "500", "20"),
			new PostDTO("https://randomuser.me/api/portraits/women/24.jpg", "Emmy Elsner", LocalDate.of(1999, 1, 20),
					...
					"654", "0", "20"),
			new PostDTO("https://randomuser.me/api/portraits/men/76.jpg", "Alf Huncoot", LocalDate.of(2003, 2, 24),
					"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident, qui?",
					"12", "4", "20"),
			new PostDTO("https://randomuser.me/api/portraits/women/76.jpg", "Lidmila Vilensky", LocalDate.of(2000, 7, 4),
					...
					"1K", "13", "26"),
			new PostDTO("https://randomuser.me/api/portraits/men/94.jpg", "Jarrett Cawsey", LocalDate.of(1914, 3, 17),
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "20"),
			new PostDTO("https://randomuser.me/api/portraits/women/94.jpg", "Tania Perfilyeva", LocalDate.of(2000, 10, 10),
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "6"),
			new PostDTO("https://randomuser.me/api/portraits/men/16.jpg", "Ivan Polo", LocalDate.of(2000, 10, 10),
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "2"),
			new PostDTO("https://randomuser.me/api/portraits/women/16.jpg", "Emelda Scandroot", LocalDate.of(2000, 10, 10),
					...
					"1K", "500", "0"),
			new PostDTO("https://randomuser.me/api/portraits/men/67.jpg", "Marcos Sá", LocalDate.of(2000, 10, 10),
					...
					"1K", "500", "20"),
			new PostDTO("https://randomuser.me/api/portraits/women/67.jpg", "Jacqueline Asong", LocalDate.of(2000, 10, 10),
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "20")

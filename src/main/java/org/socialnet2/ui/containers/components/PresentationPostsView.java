...
public class PresentationPostsView extends Div {
	public static List<PostData> postData = Arrays.asList( //
			new PostData("https://randomuser.me/api/portraits/men/42.jpg", "John Smith", "May 8",
					...
					"10K", "22", "11"),
			new PostData("https://randomuser.me/api/portraits/women/42.jpg", "Abagail Libbie", "May 3",
					...
					"1K", "500", "20"),
			new PostData("https://randomuser.me/api/portraits/men/24.jpg", "Alberto Raya", "May 3",
					...
					"1K", "500", "20"),
			new PostData("https://randomuser.me/api/portraits/women/24.jpg", "Emmy Elsner", "Apr 22",
					...
					"654", "0", "20"),
			new PostData("https://randomuser.me/api/portraits/men/76.jpg", "Alf Huncoot", "Apr 21",
					"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident, qui?",
					"12", "4", "20"),
			new PostData("https://randomuser.me/api/portraits/women/76.jpg", "Lidmila Vilensky", "Apr 17",
					...
					"1K", "13", "26"),
			new PostData("https://randomuser.me/api/portraits/men/94.jpg", "Jarrett Cawsey", "Apr 17",
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "20"),
			new PostData("https://randomuser.me/api/portraits/women/94.jpg", "Tania Perfilyeva", "Mar 8",
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "6"),
			new PostData("https://randomuser.me/api/portraits/men/16.jpg", "Ivan Polo", "Mar 5",
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "2"),
			new PostData("https://randomuser.me/api/portraits/women/16.jpg", "Emelda Scandroot", "Mar 5",
					...
					"1K", "500", "0"),
			new PostData("https://randomuser.me/api/portraits/men/67.jpg", "Marcos Sá", "Mar 4",
					...
					"1K", "500", "20"),
			new PostData("https://randomuser.me/api/portraits/women/67.jpg", "Jacqueline Asong", "Mar 2",
					"In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
					"1K", "500", "20")
	...
	public PresentationPostsView() {
		...
		for (PostData postData : PresentationPostsView.postData) {
			HorizontalLayout card = new MediaObject(postData);
			add(card);
		}
	}
}
